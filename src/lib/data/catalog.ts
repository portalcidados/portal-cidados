...
export const catalogData: DataCatalogItem[] = [
  {
    id: "1",
    title: "Imposto sobre Transmissão de Bens Imóveis (ITBI), São Paulo-SP [2006-2025]",
  ...
  {
    id: "2",
    title: "Rotas dos entregadores parcerios do iFood, São Paulo-SP [?,?]",
  ...
  {
    id: "3",
    title: "Programas educacionais do iFood, ? [?,?]",
    ...
    region: "Brasil",
    accessMethod: "Sala segura do Insper",
    keywords: ["Motociclistas", "Entregas por aplicativo", "Logistica urbana", "Qualificação profissional"],
    createdAt: "2025-10-29",
    tags: ["Educação", "Brasil", "Sala segura do Insper"]
  },
  {
    id: "4",
    title: "Ganhos dos entregadores parceiros do iFood,? [?,?]",
    ...
    createdAt: "2025-10-29",
    tags: ["Trabalho e renda", "Brasil", "Sala segura do Insper"]
  },
  {
    id: "5",
    title: "Cadastro de imóveis para cobrança do Imposto Predial e Territorial Urbano (IPTU), ? [2024]",
    description: "Informações sobre os imóveis formais de uso residencial, comercial.\nConjunto de dados tratados e enriquecidos pelo Centro de Estudos das Cidades.",
    theme: "Habitação e Mercado Imobiliário",
    region: "São Paulo",
    accessMethod: "Disponível para download",
  ...
  {
    id: "6",
    title: "Alvarás de licencimento de novas edificações, São Paulo-SP [2004, 2024]",
  ...
  },
  {
    ...
    description: "Dados demográficos e habitaciaonais agregados em um raster de 800x800m, resultado de interpolação (por área) de informações do Censo (2022) e do IPTU de São Paulo. Contém medidas de densidade populacional e de informalidade dos imóveis.\nConjunto de dados preparado para o estudo [colocar nome do estudo do Gustavo]",
    theme: "Habitação e Mercado Imobiliário",
    region: "São Paulo",
    accessMethod: "Disponível para download",
  ...
  },
  {
    ...
    description: "Cruzamento entre os lotes do IPTU de São Paulo com dados do CENSO, via interpolação de área, agregada por setor censitário. Conjunto de dados preparado para o estudo [colocar nome do estudo do Gustavo]",
    theme: "Habitação e Mercado Imobiliário",
    region: "São Paulo",
    accessMethod: "Disponível para download",
    keywords: ["Habitação", "Moradia", "Densidade Populacional", "Verticalização", "IPTU São Paulo"],
  ...
  },
  {
    ...
    description: "Total de embarques mensais mensais por estação de trem/metrô dos sistemas operados pela Motiva. Dados incluem Metrô Bahia, ViaQuatro, ViaMobilidade (Linhas 5, 8 e 9) e VLT Carioca.",
    theme: "Mobilidade",
    region: "Brasil",
    accessMethod: "Disponível para download",
    keywords: ["Transporte público", "Demanda de passageiros", "Sistemas metroferroviários", "Metrô", "VLT"],
  ...
  {
    id: "22",
    title: "Média de embarques diários nas estações de trem/metrô operados pela Motiva",
  ...
  },
  {
    ...
    region: "Salvador",
    accessMethod: "Disponível para download",
    keywords: ["Transporte público", "Demanda de passageiros", "Sistemas metroferroviários", "Intregração de modais", "Metrô"],
    createdAt: "2025-10-29",
...
export const filterOptions = {
  themes: ["Habitação e Mercado Imobiliário", "Mobilidade", "Educação", "Trabalho e renda", "Multidiciplinar e transversal", "Saúde", "Clima e Meio Ambiente"],
  regions: ["São Paulo", "Brasil", "Rio de Janeiro", "Salvador"],
