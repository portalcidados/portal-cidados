...
const solucoesItems: SolucaoItem[] = [
  {
    ...
    description:
      "Desenvolver e expandir áreas verdes, parques e/ou jardins: incentivar e promover a arborização urbana e criação de corredores ecológicos; recuperar áreas de mangue.",
  ...
  },
  {
    ...
    description:
      "Acréscimo de pessoas ao quadro de funcionários da Comlurb para atender a população da Maré; remoção dos pontos de acúmulo de lixo no interior da favela; estruturar locais adequados para a disposição do lixo.",
    textPosition: "top-right",
  },
  {
  ...
  },
  {
    ...
    description:
      "Estabelecer uma rede complementar de monitoramento climático e de qualidade do ar, investir em pesquisa para avaliar constantemente os impactos de políticas climáticas implantadas, investimento em tecnologias modernas para análise em tempo real e divulgação transparente dos resultados.",
  ...
  },
  {
    ...
    description:
      "Desenvolver planos locais de mitigação das ilhas de calor e diminuição da poluição do ar, os articulando e inserindo nos projetos e programas governamentais já em desenvolvimento.",
    textPosition: "top-right",
  },
  {
