...
export const layerStyles: Record<string, LayerStyle> = {
  ...
  sinistros_trechos: {
    ...
    slot: "",
    "source-layer": "sinistros_trechos",
  },
  sinistros_distritos: {
  ...
  densidade_habitacional_setor: {
    layout: {
      visibility: "none",
    },
    type: "fill",
    source: "composite",
    id: "densidade-habitacional-setor",
    paint: {
      "fill-color": [
        "interpolate",
        ["linear"],
    ...
    slot: "",
    "source-layer": "densidade_habitacional_setor",
  },
  densidade_populacional_setor: {
    layout: {
      visibility: "none",
    },
    type: "fill",
