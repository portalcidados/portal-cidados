    ...
    <div className="relative w-full h-screen min-h-lvh">
      ...
      >
        <div className="p-4 border-b md:hidden">
          <button className="z-20 text-gray-900 pb-4 flex pt-2 hover:cursor-pointer text-sm mr-2 bg-transparent p-0 flex-row items-center gap-2" onClick={() => router.back()}><ChevronLeftIcon className="w-5 h-5" /> Voltar</button>
          <h2 className="text-lg font-semibold text-gray-900">Selecione a cidade</h2>
        </div>

        <div className="flex flex-col h-full">
          <div className="md:px-4 md:pt-4">
          <button className="z-20 text-gray-900 pb-4 hidden md:flex pt-2 hover:cursor-pointer text-sm mr-2 bg-transparent p-0 flex-row items-center gap-2" onClick={() => router.back()}><ChevronLeftIcon className="w-5 h-5" /> Voltar</button>
       ...
       <div className="absolute top-4 right-4 z-9">
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              <Layers className={`w-5 h-5 ${isComparisonMode ? 'text-white' : 'text-gray-900'}`}/>
            </button>
          </TooltipTrigger>
