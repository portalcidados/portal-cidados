...
export default function PropertyMap() {
  ...
  return (
    <div className="relative w-full h-screen min-h-lvh">
      ...
      <div
        className={`absolute bg-white top-6 left-6 z-20 overflow-y-auto! w-80 lg:min-h-[calc(100vh-48px)] max-h-[calc(100vh-48px)] shadow-lg transition-transform duration-300 ease-in-out
      ...
      >
        <div className="p-4 border-b md:hidden">
          <button
            className="z-20 pb-4 flex pt-2 hover:cursor-pointer text-sm mr-2 bg-transparent p-0 flex-row items-center gap-2"
            onClick={() => router.back()}
          >
        ...
        <div className="flex flex-col h-full">
          <div className="md:p-4">
            <button
              className="z-20 pb-4 hidden md:flex pt-2 hover:cursor-pointer text-sm mr-2 bg-transparent p-0 flex-row items-center gap-2"
              onClick={() => router.back()}
            >
              <ChevronLeftIcon className="w-5 h-5" /> Voltar
            </button>
