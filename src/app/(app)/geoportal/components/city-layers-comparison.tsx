                ...
                {cityLayers.map((layer, index) => {
                  ...
                  return (
                    <div key={`layer1-${layer.id}`}>
                      <div
                        className={`px-4 gap-4 flex items-center justify-between py-3 transition-colors ${
                          isSelected
                            ? "bg-blue-50 border-l-4 border-l-blue-500"
                            : isDisabled
                              ? "bg-gray-100 opacity-50 cursor-not-allowed"
                              : attentionState.show &&
                                  attentionState.target === "layer1"
                      ...
                      >
                        ...
                        <SwitchLight
                          ...
                          disabled={
                            layerLoadingStates[layer.id] === "loading" ||
                            isDisabled
                          }
                        />
                      </div>
                    ...
                    <div key={`layer2-${layer.id}`}>
                      ...
                      >
                        ...
                        <SwitchLight
                          ...
                          checked={isSelected}
                          onCheckedChange={(checked) =>
                            handleLayerToggle(layer.id, checked, false)
                          }
                          disabled={
                            layerLoadingStates[layer.id] === "loading" ||
                            isDisabled
